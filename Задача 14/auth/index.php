...
<body background = "img/seredina_dorogi_1920x1200.jpg" class="fon">
    ...
    <div class="container cen">
        ...
        <h2 align="center">Ты тут первый раз? <br> Тогда предлогаю пройти <a href="html/Reges.php">регистрацию</a> для дальнейших поездок!</h2>
        <h2 align="center">А если у тебя есть аккаунт, то просто войди в свой <a href="html/auth.html.php">кабинет</a></h2>
    </div>
    <?php else: ?>
    <div class="container" align="center">
        <h1 align="center">Привет <?=$_COOKIE['name']?>. <br>Добро пожаловать в личный кабинет.</h1>
        <h2 align="center">Вы тут можете поменять пароль, Имя, заполнить свою Фамилию, изменить почту и так же логин.</h2>



            <div class="container">
                <div class="row">
                    <div class="col-6 col-md-2"><label for="disabledTextInput" class="str2" ><strong><big> Ваш номер</big></strong></label></div>
