...
<body background = "../img/seredina_dorogi_1920x1200.jpg" class="fon">
    ...
    <div class="container cen">
        ...
        <h2 align="center">Ты тут первый раз? <br> Тогда предлогаю пройти <a href="Reges.php">регистрацию</a> для дальнейших поездок!</h2>
        <h2 align="center">А если у тебя есть аккаунт, то просто войди в свой <a href="auth.html.php">кабинет</a></h2>
    </div>
        <?php
        if($_SESSION['user_id']) {
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 col-md-6">
                        ...
                        <form action="lichn.php" method="post" class="for">
                ...
                <div class="col-6 col-md-4">
                        ...
                        <form action="../php/warframe.php" method="get" style="margin-left: -90px">
                            <button type="submit" name="mytrip" class="btn btn-warning">Мои поездки</button><br><br>
                        </form>
                        <form action="../php/warframe.php" method="get" style="margin-left: -90px">
                ...
                <div class="col-6 col-md-2">
                    <?if($_SESSION['rol'] == true): ?>
                        <p class="role">
                            <?if($_SESSION['role'] == number_format(0)): ?><strong>Статус роли: <br> Рядовой.</strong>
                            <?elseif ($_SESSION['role'] == 1): ?><strong>Статус роли: <br>Сержант.</strong>
                            <?elseif ($_SESSION['role'] == 2): ?><strong>Статус роли: <br>Ветеран.</strong>
