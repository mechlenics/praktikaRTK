...
$result = mysqli_query($mysql,"SELECT * FROM trip");
?>
<!DOCTYPE>
<html>
<head>
            ...
            <div class="results">
                <table class="table">
                    ...
                    <tr class="table-secondary">
                        ...
                        <th scope="col">День выезда</th>
                        <th scope="col">Время прибытия</th>
                        <th scope="col">Время поездки</th>
                        ...
                        <tr class="table-secondary">
                            ...
                            <td>
                                <form action="code/code_change.php" method="get" >
                                    ...
                                    <input type="hidden" name="Time_in_road" value="<?=$value['Time in road']?>">
            ...
            <table>
                <td>
                    <form action="code/code_change.php" method="post" class="oil t">
                        ...
                        <input type="date" name="D" value="<?=$_SESSION['D']?>" class="form-control" id="exampleFormControlInput1" placeholder="День поездки" required>
                        ...
                        <input type="time" name="Time" value="<?=$_SESSION['Time']?>" class="form-control" id="exampleFormControlInput1" placeholder="Время в дороге" required>
