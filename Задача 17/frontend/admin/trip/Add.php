           ...
           <table>
                <td>
                    <form action="code/code_add.php" method="post" class="oil t">
                        ...
                        <input type="date" name="D" class="form-control" id="exampleFormControlInput1" placeholder="День выезда" required>
                        <input type="time" name="Arr" class="form-control" id="exampleFormControlInput1" placeholder="Время прибытия" required>
                        <input type="time" name="Time" class="form-control" id="exampleFormControlInput1" placeholder="Время в дороге" required>
